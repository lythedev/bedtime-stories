  ...
  return (
    <div className="space-y-12">
      ...
      <section className="text-center space-y-6">
        <h1 className="text-5xl font-bold text-primary-800">Magical Bedtime Stories</h1>
      ...
      <section>
        <h2 className="text-3xl font-semibold text-primary-700 mb-6">Featured Stories</h2>
          ...
          {featuredStories.map((story) => (
            <Link href={`/stories/${story.id}`} key={story.id}>
              <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl story-card">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-primary-800 mb-2">{story.title}</h3>
      ...
      <section className="bg-primary-50 p-8 rounded-xl">
        <h2 className="text-3xl font-semibold text-primary-700 mb-6 text-center">Why Bedtime Stories Matter</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-xl font-bold text-primary-800 mb-2">Boosts Imagination</h3>
            <p className="text-gray-600">
              Stories transport children to magical worlds, fostering creativity and imagination.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-xl font-bold text-primary-800 mb-2">Improves Language</h3>
            <p className="text-gray-600">Regular reading exposes children to rich vocabulary and language patterns.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-xl font-bold text-primary-800 mb-2">Creates Bonding</h3>
            <p className="text-gray-600">
